...
from ui.pages.history_page import create_history_view
from ui.pages.parser_bot_page import create_parser_bot_view
from ui.pages.smartmoney_bot_page import create_smartmoney_bot_view
from ui.pages.mt5_page import create_mt5_view
...
def main():
    """Главная функция запуска UI приложения"""
    ft.app(
        target=start_ui,
        assets_dir="assets"
    )
